...
import com.algogence.articleview.svg.utils.RenderOptionsBase;

/**
 * A fluent builder class that creates a render configuration object for the
 * {@link SVG#renderToCanvas(Canvas, com.algogence.articleview.svg.RenderOptions)} and {@link SVG#renderToPicture(int,int, com.algogence.articleview.svg.RenderOptions)} methods.
 *
 * <h3>Example usage</h3>
 *
...
public class RenderOptions extends RenderOptionsBase
{
    ...
    */
   public static com.algogence.articleview.svg.RenderOptions create()
   {
      return new com.algogence.articleview.svg.RenderOptions();
   }
    ...
    */
   public RenderOptions(com.algogence.articleview.svg.RenderOptions other)
   {
      super(other);
   }
    ...
    */
   public com.algogence.articleview.svg.RenderOptions css(String css)
   {
      return (com.algogence.articleview.svg.RenderOptions) super.css(css);
   }
   ...
   public com.algogence.articleview.svg.RenderOptions preserveAspectRatio(com.algogence.articleview.svg.PreserveAspectRatio preserveAspectRatio)
   {
      return (com.algogence.articleview.svg.RenderOptions) super.preserveAspectRatio(preserveAspectRatio);
   }
    ...
    *
    * Note: setting this option will override any {@link #viewBox(float,float,float,float)} or {@link #preserveAspectRatio(com.algogence.articleview.svg.PreserveAspectRatio)} settings.
    *
    * @param viewId the id attribute of the view that should be used for rendering
    * @return this same <code>RenderOptions</code> instance
    */
   public com.algogence.articleview.svg.RenderOptions view(String viewId)
   {
      return (com.algogence.articleview.svg.RenderOptions) super.view(viewId);
   }
    ...
    * @return this same <code>RenderOptions</code> instance
    */
   public com.algogence.articleview.svg.RenderOptions viewBox(float minX, float minY, float width, float height)
   {
      return (com.algogence.articleview.svg.RenderOptions) super.viewBox(minX, minY, width, height);
   }
    ...
    * @return this same <code>RenderOptions</code> instance
    */
   public com.algogence.articleview.svg.RenderOptions viewPort(float minX, float minY, float width, float height)
   {
      return (com.algogence.articleview.svg.RenderOptions) super.viewPort(minX, minY, width, height);
   }
    ...
    * @return this same <code>RenderOptions</code> instance
    */
   public com.algogence.articleview.svg.RenderOptions target(String targetId)
   {
      return (com.algogence.articleview.svg.RenderOptions) super.target(targetId);
   }
