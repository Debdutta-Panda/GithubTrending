...
import com.algogence.articleview.R;
...
public class SVGImageView extends ImageView
{
   ...
   private final com.algogence.articleview.svg.RenderOptions renderOptions = new com.algogence.articleview.svg.RenderOptions();
   ...
   private class LoadResourceTask extends AsyncTask<Integer, Integer, SVG>
   {
      ...
      {
         com.algogence.articleview.svg.SVGImageView.this.svg = svg;
         doRender();
      }
   }
