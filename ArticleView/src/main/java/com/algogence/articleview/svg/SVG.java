...
import com.algogence.articleview.svg.utils.SVGBase;
...
public class SVG
{
    ...
    * @throws com.algogence.articleview.svg.SVGParseException if there is an error parsing the document.
    */
   @SuppressWarnings("WeakerAccess")
   public static com.algogence.articleview.svg.SVG getFromInputStream(InputStream is) throws com.algogence.articleview.svg.SVGParseException
   {
      return new com.algogence.articleview.svg.SVG(SVGBase.getFromInputStream(is));
   }
   ...
   public static com.algogence.articleview.svg.SVG getFromString(String svg) throws com.algogence.articleview.svg.SVGParseException
   {
      return new com.algogence.articleview.svg.SVG(SVGBase.getFromString(svg));
   }
    ...
    */
   @SuppressWarnings("WeakerAccess")
   public static com.algogence.articleview.svg.SVG getFromResource(Context context, int resourceId) throws com.algogence.articleview.svg.SVGParseException
   {
    ...
    */
   @SuppressWarnings("WeakerAccess")
   public static com.algogence.articleview.svg.SVG getFromResource(Resources resources, int resourceId) throws com.algogence.articleview.svg.SVGParseException
   {
      return new com.algogence.articleview.svg.SVG(SVGBase.getFromResource(resources, resourceId));
   }
    ...
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public static com.algogence.articleview.svg.SVG getFromAsset(AssetManager assetManager, String filename) throws com.algogence.articleview.svg.SVGParseException, IOException
   {
      return new com.algogence.articleview.svg.SVG(SVGBase.getFromAsset(assetManager, filename));
   }
    ...
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public Picture renderToPicture(com.algogence.articleview.svg.RenderOptions renderOptions)
   {
    ...
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public Picture renderToPicture(int widthInPixels, int heightInPixels, com.algogence.articleview.svg.RenderOptions renderOptions)
   {
   ...
   {
      renderToCanvas(canvas, (com.algogence.articleview.svg.RenderOptions) null);
   }
    ...
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public void  renderToCanvas(Canvas canvas, com.algogence.articleview.svg.RenderOptions renderOptions)
   {
   ...
   {
      renderToCanvas(canvas, com.algogence.articleview.svg.RenderOptions.create().view(viewId));
   }
    ...
    * @throws com.algogence.articleview.svg.SVGParseException if {@code value} cannot be parsed successfully.
    * @throws IllegalArgumentException if there is no current SVG document loaded.
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public void  setDocumentWidth(String value) throws com.algogence.articleview.svg.SVGParseException
   {
    ...
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public void  setDocumentHeight(String value) throws com.algogence.articleview.svg.SVGParseException
   {
    ...
    * documentation for {@link com.algogence.articleview.svg.PreserveAspectRatio} for more information
    ...
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public void  setDocumentPreserveAspectRatio(com.algogence.articleview.svg.PreserveAspectRatio preserveAspectRatio)
   {
    ...
    * element in the form of an {@link com.algogence.articleview.svg.PreserveAspectRatio} object.
    * 
    * @return the preserveAspectRatio setting of the document's root {@code <svg>} element.
    * @throws IllegalArgumentException if there is no current SVG document loaded.
    */
   @SuppressWarnings({"WeakerAccess", "unused"})
   public com.algogence.articleview.svg.PreserveAspectRatio getDocumentPreserveAspectRatio()
   {
