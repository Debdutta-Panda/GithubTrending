...
package com.algogence.articleview.svg;

import com.algogence.articleview.svg.utils.TextScanner;
...
public class PreserveAspectRatio
{
   ...
   public static final com.algogence.articleview.svg.PreserveAspectRatio UNSCALED = new com.algogence.articleview.svg.PreserveAspectRatio(null, null);
   ...
   public static final com.algogence.articleview.svg.PreserveAspectRatio STRETCH = new com.algogence.articleview.svg.PreserveAspectRatio(Alignment.none, null);
    ...
    */
   @SuppressWarnings("WeakerAccess")
   public static final com.algogence.articleview.svg.PreserveAspectRatio LETTERBOX = new com.algogence.articleview.svg.PreserveAspectRatio(Alignment.xMidYMid, Scale.meet);
    ...
    */
   @SuppressWarnings("unused")
   public static final com.algogence.articleview.svg.PreserveAspectRatio START = new com.algogence.articleview.svg.PreserveAspectRatio(Alignment.xMinYMin, Scale.meet);
    ...
    */
   @SuppressWarnings("unused")
   public static final com.algogence.articleview.svg.PreserveAspectRatio END = new com.algogence.articleview.svg.PreserveAspectRatio(Alignment.xMaxYMax, Scale.meet);
    ...
    */
   @SuppressWarnings("unused")
   public static final com.algogence.articleview.svg.PreserveAspectRatio TOP = new com.algogence.articleview.svg.PreserveAspectRatio(Alignment.xMidYMin, Scale.meet);
    ...
    */
   @SuppressWarnings("unused")
   public static final com.algogence.articleview.svg.PreserveAspectRatio BOTTOM = new com.algogence.articleview.svg.PreserveAspectRatio(Alignment.xMidYMax, Scale.meet);
    ...
    */
   @SuppressWarnings("unused")
   public static final com.algogence.articleview.svg.PreserveAspectRatio FULLSCREEN = new com.algogence.articleview.svg.PreserveAspectRatio(Alignment.xMidYMid, Scale.slice);
    ...
    */
   @SuppressWarnings("unused")
   public static final com.algogence.articleview.svg.PreserveAspectRatio FULLSCREEN_START = new com.algogence.articleview.svg.PreserveAspectRatio(Alignment.xMinYMin, Scale.slice);
   ...
   static {
      aspectRatioKeywords.put("none", com.algogence.articleview.svg.PreserveAspectRatio.Alignment.none);
      aspectRatioKeywords.put("xMinYMin", com.algogence.articleview.svg.PreserveAspectRatio.Alignment.xMinYMin);
      aspectRatioKeywords.put("xMidYMin", com.algogence.articleview.svg.PreserveAspectRatio.Alignment.xMidYMin);
      aspectRatioKeywords.put("xMaxYMin", com.algogence.articleview.svg.PreserveAspectRatio.Alignment.xMaxYMin);
      aspectRatioKeywords.put("xMinYMid", com.algogence.articleview.svg.PreserveAspectRatio.Alignment.xMinYMid);
      aspectRatioKeywords.put("xMidYMid", com.algogence.articleview.svg.PreserveAspectRatio.Alignment.xMidYMid);
      aspectRatioKeywords.put("xMaxYMid", com.algogence.articleview.svg.PreserveAspectRatio.Alignment.xMaxYMid);
      aspectRatioKeywords.put("xMinYMax", com.algogence.articleview.svg.PreserveAspectRatio.Alignment.xMinYMax);
      aspectRatioKeywords.put("xMidYMax", com.algogence.articleview.svg.PreserveAspectRatio.Alignment.xMidYMax);
      aspectRatioKeywords.put("xMaxYMax", com.algogence.articleview.svg.PreserveAspectRatio.Alignment.xMaxYMax);
   }
    ...
    */
   public static com.algogence.articleview.svg.PreserveAspectRatio of(String value)
   {
      try {
   ...
   public boolean equals(Object obj)
   {
      ...
      if (getClass() != obj.getClass())
         return false;
      com.algogence.articleview.svg.PreserveAspectRatio other = (com.algogence.articleview.svg.PreserveAspectRatio) obj;
   ...
   private static com.algogence.articleview.svg.PreserveAspectRatio parsePreserveAspectRatio(String val) throws SVGParseException
   {
      ...
      com.algogence.articleview.svg.PreserveAspectRatio.Alignment  align = aspectRatioKeywords.get(word);
      com.algogence.articleview.svg.PreserveAspectRatio.Scale      scale = null;
      ...
      if (!scan.empty()) {
         ...
         switch (meetOrSlice) {
            case "meet":
               scale = com.algogence.articleview.svg.PreserveAspectRatio.Scale.meet; break;
            case "slice":
               scale = com.algogence.articleview.svg.PreserveAspectRatio.Scale.slice; break;
            default:
               throw new SVGParseException("Invalid preserveAspectRatio definition: " + val);
         }
      }
      return new com.algogence.articleview.svg.PreserveAspectRatio(align, scale);
   }
